...
<header class="px-4 py-3" style="background: rgba(18,22,33,0.85); box-shadow: 0 2px 16px rgba(0,0,0,0.25); position: fixed; width: 100%; z-index: 1050;">
        ...
        <nav>
            <ul class="d-flex align-items-center justify-content-between list-unstyled mb-0" style="width: 100%;">
                ...
                <li class="d-flex align-items-center justify-content-start" style="min-width: 160px;">
                    <button class="btn p-0 border-0 bg-transparent" id="sidenavToggle" aria-label="Abrir menú lateral" style="color: var(--golden-bloom);">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.1" stroke-linecap="round" stroke-linejoin="round">
                ...
                <li class="d-flex justify-content-center flex-grow-1">
                    <a href="{{ route('home') }}" class="d-flex align-items-center text-decoration-none">
                        <img src="{{ asset('images/logo.jpg') }}" alt="Logo" height="44" style="border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.18);">
                    </a>
                </li>
                        ...
                        <a href="{{ route('login') }}" class="btn d-flex align-items-center"
                           style="border: 2px solid var(--golden-bloom); color: var(--golden-bloom); background: transparent; font-family: var(--font-title); font-weight: 700;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                ...
                                <path d="M13.468 12.37C12.758 11.226 11.275 10.5 8 10.5s-4.758.726-5.468 1.87A6.978 6.978 0 0 0 8 15a6.978 6.978 0 0 0 5.468-2.63z"/>
                    ...
                    @else
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mt-2 shadow"
                                ...
                                <li><hr class="dropdown-divider" style="border-color: var(--golden-bloom);"></li>
                                <li>
